...
- runtime probe: `python3 runtime_probe.py`
...
- `python3 runtime_probe.py run-baseline --output-dir <dir> [--scenario-groups bootstrap threads] [--server-program /path/to/codex]`
